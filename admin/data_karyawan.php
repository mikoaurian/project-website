			...
			?>
				<tr align="center">
					...
					<td>
						...
						<!-- end button edit -->
						<a href='?mod=hapus_karyawan&nomor_induk=<?php echo $nomor_induk; ?>' onclick="return confirm('Data akan dihapus ?')" class="btn btn-primary">
							<!-- icon hapus -->
...
for ($i = 1; $i <= $banyakhalaman; $i++) {
	if ($page != $i) {
		//echo "<li><a href='admin/?mod=data_karyawan&page=".$i."'></a></li>";
?>
		<li><a href="?mod=data_karyawan&page=<?php echo '$i;' ?>"></a></li>
<?php
	} else {
		echo "[$i]";
	}
